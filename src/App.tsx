...
3. 生数科技与清华大学发布视频大模型Vidu:采用Diffusion与Transformer融合架构，一键生成高清视频，国际领先。4.Mutable Al推出Auto Wiki v2:自动将代码转化为维基百科风格的文章:解决代码文档化难题。
5. 谷歌在美国新建数据中心:计划投资30亿美元在印第安纳州建设数据中心园区，扩建弗吉尼亚州设施，推出人工智能机会基金。6.中国信息通信研究院发布汽车大模型标准:旨在规范和推动汽车行业智能化发展。
